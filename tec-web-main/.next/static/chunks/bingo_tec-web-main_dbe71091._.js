...
function AdminDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$bingo$2f$tec$2d$web$2d$main$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
            ...
            const checkAdmin = {
                "AdminDashboard.useEffect.checkAdmin": async ()=>{
                    if (!storedToken) {
            ...
            }["AdminDashboard.useEffect.checkAdmin"];
            checkAdmin();
        }
    }["AdminDashboard.useEffect"], []);
    const handleNavigation = (path)=>{
        router.push("/admin/".concat(path));
    };
    const handleLogout = ()=>{
...
_s(AdminDashboard, "0rblLhUen8bqzxU0EPbYcxGaXgY=", false, function() {
    return [
...
//# sourceMappingURL=bingo_tec-web-main_dbe71091._.js.map