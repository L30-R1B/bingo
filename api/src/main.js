...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function() {
        var app, reflector, port, _a, _b, _c;
        return __generator(this, function(_d) {
            switch (_d.label) {
                ...
                case 1:
                    app = _d.sent();
                    app.enableCors({
                        origin: ['http://localhost:3000', 'http://192.168.0.127:3000'], // Em produção, restrinja para o domínio do seu frontend
                ...
                case 2:
                    _d.sent();
                    _b = (_a = console).log;
                    _c = "\uD83D\uDE80 Aplica\u00E7\u00E3o rodando em: ".concat;
                    return [4 /*yield*/ , app.getUrl()];
                case 3:
                    _b.apply(_a, [_c.apply("\uD83D\uDE80 Aplica\u00E7\u00E3o rodando em: ", [_d.sent()])]);
                    return [2 /*return*/ ];
            }
        });
    });
